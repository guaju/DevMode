package com.guaju.devmode.qiniu;
...
public class QiniuUtils {
    //空间名称
  static final  String SPACENAME="smartisan";
  static final String AccessKey="TD5xG3ihrEeq4SAuxdqu3Lt6bvLZSnF12P9E6mC4";
  static final String SecretKey="e4If_nSDkYRNsLr3TOd5uIAcxHCxzSYDdV4xp2FH";
...
//  static final String SecretKey="MY_SECRET_KEY";
  private static UploadManager uploadManager;
    ...
    public static String calcToken(String picName) throws Exception {
        //1、构建上传策略
        String scope=SPACENAME+":"+picName;
...
//        long deadline= 1451491200;
     ...
     * @param token     计算出来的token值
     */
    public static void uploadPic(String filePath,String picName,String token){
